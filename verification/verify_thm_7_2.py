"""Theorem 12.1: ensembles.  Averaging k rank-m sketches has correlation
...
approaches 1/sqrt(2) at km = d.  The filename retains the number from the
...
@check("Thm 12.1", "ensemble averaging constant + 1/sqrt(2) gap")
def run():
